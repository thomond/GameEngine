...
class Player : public Actor
{
	...
	void handleEvent(SDL_Event& e){
		...
		if (e.key.type == SDL_KEYDOWN && !e.key.repeat)
		{
			...
			{
				case SDLK_a: setVelocity(Point(-mSpeedDef,0)); break;
				case SDLK_d: setVelocity(Point(mSpeedDef,0)); break;
				case SDLK_w: setVelocity(Point(0,-mSpeedDef)); break;
                case SDLK_s: setVelocity(Point(0,mSpeedDef));break;
			}
		}
